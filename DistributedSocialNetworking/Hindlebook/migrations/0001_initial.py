    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(height_field=100, width_field=100, null=True, upload_to=b'', blank=True)),
                ('github_id', models.CharField(default=b'', max_length=30, blank=True)),
                ('about', models.CharField(default=b"This user hasn't filled out their profile yet!", max_length=250, blank=True)),
